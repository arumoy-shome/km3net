...
%% The output of the PMC is used by the steps that follow so any
%% shortcomings of the PMC cascade down the pipeline and affect the
%% performance of the latter steps and the pipeline as a whole. For
%% instance, the communities created by the CPM is directly affected by
%% the edge weights provided by the PMC.
