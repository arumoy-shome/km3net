...
\hspace*{-7.5cm}\includegraphics[height=25mm]{0-frontmatter/figures/vu-griffioen.pdf}

\vspace*{-2cm}\hspace*{7.5cm}\includegraphics[height=15mm]{0-frontmatter/figures/uva_logo.jpg}
...
\include{0-frontmatter/acknowledgement}
...
% 
%\include{0-frontmatter/glossary} 
...
\include{2-data-preparation/data-preparation}
\include{3-data-exploration/data-exploration}
...
\bibliography{7-references/references} % adjust this to fit your BibTex file
